  ...
  // ---------- Storefront ----------
  {
    ...
    children: [
      ...
      },
      {
        path: 'products',
        loadComponent: () =>
          import('./features/product/product-listing/product-listing.component').then(
      ...
      // ---------- SEO & Cisco Talos Trust Pages ----------
      {
        path: 'about-us',
        loadComponent: () => import('./features/static/about/about').then((m) => m.About),
        title: 'About Us — Ladies Apparel',
      },
      {
        path: 'contact-us',
        loadComponent: () => import('./features/static/contact/contact').then((m) => m.Contact),
        title: 'Contact Support — Ladies Apparel',
      },
      {
        path: 'privacy-policy',
        loadComponent: () => import('./features/static/privacy/privacy').then((m) => m.Privacy),
        title: 'Privacy Policy — Ladies Apparel',
      },
      {
        path: 'terms-and-conditions',
        loadComponent: () => import('./features/static/terms/terms').then((m) => m.Terms),
        title: 'Terms and Conditions — Ladies Apparel',
      },
      {
        path: 'shipping-and-returns',
        loadComponent: () =>
          import('./features/static/shipping-returns/shipping-returns').then(
            (m) => m.ShippingReturns,
          ),
        title: 'Shipping & Returns Policy — Ladies Apparel',
      },
    ],
  },
  ...
  // ---------- Admin Panel ----------
  {
    ...
    children: [
      ...
      },
      {
        path: 'returns',
        loadComponent: () =>
          import('./features/admin/returns/returns.component').then((m) => m.AdminReturnsComponent),
        title: 'Returns & Exchanges — Admin',
      },
      {
        path: 'coupons',
        loadComponent: () =>
          import('./features/admin/coupons/coupons.component').then((m) => m.AdminCouponsComponent),
        title: 'Manage Coupons — Admin',
      },
      {
        path: 'banners',
        loadComponent: () =>
          import('./features/admin/banners/banners.component').then((m) => m.AdminBannersComponent),
      ...
      },
      {
        path: 'reviews',
        loadComponent: () =>
          import('./features/admin/reviews/reviews.component').then((m) => m.AdminReviewsComponent),
        title: 'Moderate Reviews — Admin',
      },
      {
        path: 'serviceability',
        loadComponent: () =>
          import('./features/admin/serviceability/serviceability.component').then(
            (m) => m.AdminServiceabilityComponent,
          ),
